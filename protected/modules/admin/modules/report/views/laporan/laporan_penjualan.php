<div class="">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Laporan <small>Laporan Penjualan</small></h2>
          ...
          <section class="content invoice" id="printArea">
            ...
            <div class="row invoice-info removePdf">
              ...
              <div class="col-sm-8 invoice-col">
                ...
                <div class="form-group">
                  <label class="control-label col-md-2 col-sm-2 col-xs-2">Nama Barang</label>
                  <div class="col-md-4 col-sm-4 col-xs-4">
                  <select class="form-control col-md-2 col-xs-2" name="barang" id="barang">
                      <option value="">--Semua Barang--</option>
                      <?php
                          $toLoop = $dataBarang;
                          $selectedType = isset($_POST['barang'])?$_POST['barang']:'-';
                          foreach($toLoop as $barang):
                              $selected = $barang->id_barang==$selectedType?'selected="selected"':'';
                      ?>
                              <option <?= $selected ?> value="<?= $barang->id_barang ?>"><?= $barang->nama_barang ?></option>
                      <?php endforeach;?>
                  </select>
                  </div>
                </div>
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        ...
                        <td><?= 'Rp. '.number_format(@$dataTotal->laba,0,'.',',');?></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
