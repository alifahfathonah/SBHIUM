                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= 'Rp. '.number_format(@$subTotalPendapatan,0,'.',',');?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><?= 'Rp. '.number_format(@$subTotalPendapatanAkhir,0,'.',',');?></td>
                      </tr>
                      <tr>
                  ...
                  <div class="x_content">
                    ...
                    <?php if(Yii::app()->user->getState('role')==1): ?><!-- Untuk Admin lihat semua -->
                      <?php foreach ($dataInvestor as $investor):?>
                          <?php 
                            $labaInvestor = $investor->slot_akhir * $labaPerSlot;
                            $labaInvestorPercent = $labaInvestor/$dataPersentase*100;
                          ?>
                            <div class="row">
                              <div class="progress_title">
                                <span class="left"><?= $investor->tUserAccount->Fullname ?></span>
                                <span class="right">Laba</span>
                                <div class="clearfix"></div>
                              </div>

                              <div class="col-xs-2">
                                <span>Slot : <?= $investor->slot_akhir ?> x <?= 'Rp. '.number_format(@$labaPerSlot,0,'.',',');?></span>
                              </div>
                              <div class="col-xs-8">
                    ...
                    <?php else:?>
                      <?php foreach ($dataInvestor as $investor):?>
                          <?php 
                            ...
                            $labaInvestorPercent = $labaInvestor/$dataPersentase*100;
                          ?>
                          <?php if(Yii::app()->user->getState('userid')==$investor->tUserAccount->userid):?>
                            <div class="row">
                              <div class="progress_title">
                                <span class="left"><?= $investor->tUserAccount->Fullname ?></span>
                                <span class="right">Laba</span>
