...
class alpha extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		$message = $this->message ? $this->message : Yii::t('alpha', '{attribute} must alphabet');
	...
	public function clientValidateAttribute($object,$attribute)
	{
		...
		$pattern = $this->elaboratePattern();
		// get the error message
		$message = $this->message ? str_replace('{attribute}', $attribute, $this->message) : Yii::t('alpha', '{attribute} must alphabet', array('{attribute}' => $attribute));
